...
ActiveRecord::Schema.define(version: 2022_02_07_180237) do
  ...
  create_table "bonds", force: :cascade do |t|
    ...
    t.index ["company_id"], name: "index_bonds_on_company_id"
    t.index ["resident_id"], name: "index_bonds_on_resident_id"
  end
  ...
  add_foreign_key "bonds", "companies"
  add_foreign_key "bonds", "residents"
